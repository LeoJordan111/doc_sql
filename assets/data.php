...
$articles = [
    [
        ...
        suivi du nom de la base de données que l'on souhaite créer.<br> 'DEFAULT CHARACTER' est un paramètre qui sert à 
        définir les caractères accepter dans la base de donnée créé.<br>
        DEFAULT COLLATE est un autre paramètre qui permet de ne pas préciser la gestion de la casse (majuscule/minuscule)",
    ...
    [
        'title' => "Créer une table de donnée",
        'article' => "Une table est un groupe de données représenter sous forme d'un tableau, il est composé de lignes et de colonnes.<br>
	    Pour créer une table, la commande 'CREATE TABLE' suivi du nom de la base de données.<br> 
        Il est nécessaire de définir les champs de la table, pour cela nommer du champ suivi de son type et si sa valeur de base peut être 'NULL' ou non.<br>
        En général, le champ 1 est un ID, c'est une clé primaire ('PRIMARY KEY'), il est auto incrémenter et non null.<br>
    ...
    [
        ...
        'article' => "Pour modifier une table, la commande 'ALTER TABLE' suivi du nom de la table que l'on souhaite modifier.<br> 
    ...
    [
        'title' => "Créer une liaison",
        'article' => "D'abord il est nécessaire de créer une colonne dans la table 'director'<br><br>
                        ALTER TABLE director<br>
                        ADD COLUMN country_id INT NOT NULL;<br><br>
                        Ensuite pour lier les 2 tables, il faut utiliser la commande ALTER TABLE puis ajouter une clé étrangère (ADD FOREYGN KEY).<br>
    ...
    [
        ...
        'article' => 'Ici, movie est le nom de la table, column1, column2, ...<br>
                    sont les noms des colonnes auxquelles vous souhaitez ajouter des données, et value1, value2, ...<br>
    ...
    [
        ...
        'article' => "'Ici, movie est le nom de la table. Ensuite, column1, column2, ...<br> 
        sont les noms des colonnes que vous souhaitez modifier, et value1, value2, ...<br> 
        sont les nouvelles valeurs que vous souhaitez définir pour ces colonnes. Enfin, condition est le critère de sélection des lignes à modifier.<br>
    ...
    [
        ...
        'article' => "'La commande ORDER BY permet de trier les données recherchées, 
                    les paramètres ASC ou DESC permettent de définir le sens du tri<br>(ASC --> ordre croissant et DESC --> ordre décroissant)<br> 
    ...
    [
        ...
        'article' => 'La commande INNER JOIN permet de faire une recherche sur plusieurs tables.<br> 
